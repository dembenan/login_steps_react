    ...
    return (
        <div className="container-fluid">
            <div className="row auth-wrapper">
                <div className="d-flex flex-column justify-content-center col-12 col-xs-6 col-sm-6 col-md-7 col-lg-6 auth-main-col">
                        ...
                        <div className="d-flex flex-column justify-content-center ">
                            ...
                            <div className="p-2">
                                <select className="form-select form-control mh-50 p-3 border bg-light input-lg" aria-label="Default select example"                                     {...register("selectedValue", {
                                    ...
                                    <option selected disabled>I would describe my user type as</option>
                                    <option value="option-3">Collaborater</option>
                            ...
                            <div className="p-2">
                                <input
                                    ...
                                    <i  className={showPassword ? 'far fa-eye' : 'fa-solid fa-eye'} ></i>
                                 </button>
                                    </div>
                ...
                <div className="col-12 col-xs-6 col-sm-6 col-md-5 col-lg-4 h-100 d-flex align-items-center justify-content-center auth-background-col">
